...
import com.rtsoft.rtsimpleapp.SharedMultiTouchInput;
...
import com.rtsoft.rtsimpleapp.BillingService.RequestPurchase;
import com.rtsoft.rtsimpleapp.BillingService.RestoreTransactions;
import com.rtsoft.rtsimpleapp.Consts.PurchaseState;
import com.rtsoft.rtsimpleapp.Consts.ResponseCode;
...
class WrapSharedMultiTouchInput
{
   ...
   static 
   {
       try
	   {
          Class.forName("com.rtsoft.rtsimpleapp.SharedMultiTouchInput");
       } 
	   catch (Exception ex) 
	   {
