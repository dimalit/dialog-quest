...
extern "C" 
{
	...
	JNIEXPORT void JNICALL Java_com_rtsoft_rtsimpleapp_SharedActivity_nativeOnKey(  JNIEnv*  env, jobject thiz,jint type, jint keycode, jint c )
	{
		AppOnKey(env, thiz, type, keycode, c);
	}
	JNIEXPORT void JNICALL Java_com_rtsoft_rtsimpleapp_SharedActivity_nativeSendGUIEx(  JNIEnv*  env, jobject thiz,jint messageType, jint parm1, jint parm2, jint finger )
	{
		AppOnSendGUIEx(env, thiz, messageType, parm1, parm2, finger);
	}
	JNIEXPORT void JNICALL Java_com_rtsoft_rtsimpleapp_SharedActivity_nativeSendGUIStringEx(  JNIEnv*  env, jobject thiz,jint messageType, jint parm1, jint parm2, jint finger, jstring s )
	{
		AppOnSendGUIStringEx(env, thiz, messageType, parm1, parm2, finger,s );
	}
	JNIEXPORT void JNICALL Java_com_rtsoft_rtsimpleapp_SharedActivity_nativeOnAccelerometerUpdate(  JNIEnv*  env, jobject thiz, jfloat x, jfloat y, jfloat z)
	{
		AppOnAccelerometerUpdate(env, thiz, x, y, z);
	}
	JNIEXPORT void JNICALL Java_com_rtsoft_rtsimpleapp_SharedActivity_nativeOnTrackball(  JNIEnv*  env, jobject thiz, jfloat x, jfloat y)
	{
		AppOnTrackball(env, thiz, x, y);
	}
	// JAKE ADDED - DO NOT REMOVE - Machineworks requires this
	JNIEXPORT void JNICALL Java_com_rtsoft_rtsimpleapp_Main_nativeOnJoyPadButtons(  JNIEnv*  env, jobject thiz, jint key, jint value)
	{
		AppOnJoypadButtons(env, thiz, key, value);
	}
	JNIEXPORT void JNICALL Java_com_rtsoft_rtsimpleapp_Main_nativeOnJoyPad(  JNIEnv*  env, jobject thiz, jfloat xL, jfloat yL, jfloat xR, jfloat yR)
	{
		AppOnJoypad(env, thiz, xL, yL, xR, yR);
	}
	JNIEXPORT void JNICALL Java_com_rtsoft_rtsimpleapp_Main_nativeOnJoyPadConnection(  JNIEnv*  env, jobject thiz, jint xL)
	{
	...
	JNIEXPORT float Java_com_rtsoft_rtsimpleapp_AppRenderer_nativeGetLastOSMessageY(JNIEnv*  env)
	{
		return AppGetLastOSMessageY(env); 
	}


	JNIEXPORT int Java_com_rtsoft_rtsimpleapp_AppRenderer_nativeGetLastOSMessageParm1(JNIEnv*  env)
	{
		return AppGetLastOSMessageParm1(env); 
	}

	JNIEXPORT jstring Java_com_rtsoft_rtsimpleapp_AppRenderer_nativeGetLastOSMessageString(JNIEnv*  env)
	{
		return AppGetLastOSMessageString(env);
	}

	JNIEXPORT jstring Java_com_rtsoft_rtsimpleapp_AppRenderer_nativeGetLastOSMessageString2(JNIEnv*  env)
	{
		return AppGetLastOSMessageString2(env);
	}
	JNIEXPORT jstring Java_com_rtsoft_rtsimpleapp_AppRenderer_nativeGetLastOSMessageString3(JNIEnv*  env)
	{
